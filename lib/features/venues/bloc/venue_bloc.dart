...
class VenueBloc extends Bloc<VenueEvent, VenueState> {
  VenueBloc({required VenueService venueService}) : _venueService = venueService, super(const VenueState.initial()) {
  ...
  Future<void> _onLoad(_LoadBusinessVenues event, Emitter<VenueState> emit) async {
  ...
  Future<void> _onCreate(_CreateVenue event, Emitter<VenueState> emit) async {
    try {
  ...
  Future<void> _onUpdate(_UpdateVenue event, Emitter<VenueState> emit) async {
    try {
