...
mixin _$BusinessModel {
 ...
 String get id; String get name; String get ownerUid; String? get phone; String? get address; String? get logoUrl;/// When true (default), player bookings are confirmed on creation; when
/// false, they land as `pending` for the owner to review and confirm.
 bool get autoConfirmBookings;@TimestampConverter() DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,ownerUid,phone,address,logoUrl,autoConfirmBookings,createdAt);

@override
String toString() {
  return 'BusinessModel(id: $id, name: $name, ownerUid: $ownerUid, phone: $phone, address: $address, logoUrl: $logoUrl, autoConfirmBookings: $autoConfirmBookings, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String name, String ownerUid, String? phone, String? address, String? logoUrl, bool autoConfirmBookings,@TimestampConverter() DateTime createdAt
});
...
/// Create a copy of BusinessModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? ownerUid = null,Object? phone = freezed,Object? address = freezed,Object? logoUrl = freezed,Object? autoConfirmBookings = null,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String ownerUid,  String? phone,  String? address,  String? logoUrl,  bool autoConfirmBookings, @TimestampConverter()  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BusinessModel() when $default != null:
return $default(_that.id,_that.name,_that.ownerUid,_that.phone,_that.address,_that.logoUrl,_that.autoConfirmBookings,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String ownerUid,  String? phone,  String? address,  String? logoUrl,  bool autoConfirmBookings, @TimestampConverter()  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _BusinessModel():
return $default(_that.id,_that.name,_that.ownerUid,_that.phone,_that.address,_that.logoUrl,_that.autoConfirmBookings,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String ownerUid,  String? phone,  String? address,  String? logoUrl,  bool autoConfirmBookings, @TimestampConverter()  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _BusinessModel() when $default != null:
return $default(_that.id,_that.name,_that.ownerUid,_that.phone,_that.address,_that.logoUrl,_that.autoConfirmBookings,_that.createdAt);case _:
  return null;
...
class _BusinessModel implements BusinessModel {
  const _BusinessModel({required this.id, required this.name, required this.ownerUid, this.phone, this.address, this.logoUrl, this.autoConfirmBookings = true, @TimestampConverter() required this.createdAt});
...
/// Create a copy of BusinessModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? ownerUid = null,Object? phone = freezed,Object? address = freezed,Object? logoUrl = freezed,Object? autoConfirmBookings = null,Object? createdAt = null,}) {
